...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative min-h-[80vh] bg-black flex flex-col justify-between pt-32 pb-12 px-6 md:px-12 overflow-hidden border-t border-white/5">
      ...
      <div className="w-full max-w-350 mx-auto mt-24 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-6 text-xs font-mono text-neutral-600">
