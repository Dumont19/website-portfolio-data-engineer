...
const stack = [
  'Python', 'Snowflake', 'Oracle', 'FastAPI', 'Next.js', 'Azure', 'AWS S3', 'DataStage', 'PostgreSQL', 'SQLAlchemy',
];
      ...
      <div className="max-w-350 mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative z-10">
          <motion.div style={{ y }}>
            ...
            <p className="text-base md:text-lg text-neutral-400 font-light leading-relaxed mb-6 max-w-lg text-justify">
                I spent eleven years in industrial inspection — qualifying welds, certifying
                pipelines, training Petrobras engineers in ultrasound and IRIS techniques.
                Precision was not a preference. It was the job. When I transitioned into
                data engineering in 2024, I brought that same standard with me.
            </p>

            <p className="text-base md:text-lg text-neutral-400 font-light leading-relaxed mb-10 max-w-lg text-justify">
                Since then I have led an on-premises to Azure migration at ISQ (ADF, Synapse,
                Databricks, Delta Lake), engineered the full DataStage 11.5 to Snowflake pipeline
                migration for a major telecom operator, and built MAF — a full-stack orchestration
                platform adopted by the project architect and estimated to save 78+ engineer-days.
                SnowPro Core certified (score 835).
            </p>
